...
static void find_all_paths_1(const char* buffer, size_t length)
{
    long all_paths = 0;
...
static void find_all_paths_2(const char* buffer, size_t length)
{
    long all_paths = 0;
...
static void find_all_paths_2_v2(const char* buffer, size_t length)
{
    long all_paths = 0;
...
void solve_day_11(const char* filename, int part, bool dryrun)
{
    ...
    {
        find_all_paths_1(buffer, buffer_length);
    }
    else if(part == 2)
    {
